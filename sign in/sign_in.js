...
import login_placeholders from "../components/string.json";
        ...
        <div id="head">
          ...
          <div className="form_class">
            <form onSubmit={handleSubmit}>
              {login_placeholders.login_placeholders.map((in_level) => (
                <div key={in_level.name}>
                  <input
                    type={in_level.type}
                    id={in_level.id}
                    placeholder={in_level.placeholder}
                    value={
                      in_level.name === "email"
                        ? email
                        : in_level.name === "username"
                        ? username
                        : password
                    }
                    onChange={(event) => {
                      if (in_level.name === "email") {
                        setEmail(event.target.value);
                      } else if (in_level.name === "username") {
